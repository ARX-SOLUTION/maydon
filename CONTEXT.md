...
- **Storage Seam (Saqlash qatlami)**: The abstract `Repo` interface hiding the underlying storage implementation (Deno KV vs Postgres vs In-Memory). All application code queries data exclusively through this seam.
